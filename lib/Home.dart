...
class _HomeState extends State<Home> {
  ...
  Future<String> fetchData() async {
    url =
        "http://api.openweathermap.org/data/2.5/weather?q=$searchlocation&appid=198c3d478febaa60a34b02cc3bf02540";
  ...
  print(longitude);
    ...
    urllocaton="http://api.openweathermap.org/data/2.5/weather?lat=$latitude&lon=$longitude&appid=198c3d478febaa60a34b02cc3bf02540";
  ...
  Widget build(BuildContext context) {
    return convertdata!=null? Scaffold(
        body: Stack(
      children: <Widget>[
        Container(
                  ...
                  Column(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text("${convertdata["weather"][0]["main"]}",
                            style:
                                TextStyle(fontSize: 24, color: Colors.white)),
                      ),
                      Container(
